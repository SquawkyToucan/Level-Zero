//EVERYONE HATES YOU PROCESSING!
void draw(){
  int bumblebeeslitheriox = 0;
  int bumblebeeslitherioy = 0;
   for(int i = 0; i < 5; i++){
     fill(255, 255, 0);
     ellipse(bumblebeeslitheriox, bumblebeeslitherioy, 60, 60);
     bumblebeeslitheriox+= 10;
     bumblebeeslitherioy+= 10;
     fill(0, 0, 0);
     ellipse(bumblebeeslitheriox, bumblebeeslitherioy, 60, 60);
     bumblebeeslitheriox+= 10;
     bumblebeeslitherioy+= 10;
