...
import javax.swing.JOptionPane;
	...
	public class BirthdayReminder {
		public static void main(String[] args) {
			...
			else if(dahPerson.equalsIgnoreCase("Lila")){
